...
int main() {
	...
	try{
		...
		sim.simulate("../output/converg_hill_schweffel_5dim",30, 5,10000,function::FunctionEnum::SCHWEFFEL, AlgorithmType::HILL_CLIMBING);
		sim.simulate("../output/converg_hill_schweffel_10dim",30, 10,10000,function::FunctionEnum::SCHWEFFEL, AlgorithmType::HILL_CLIMBING);
		sim.simulate("../output/converg_hill_schweffel_20dim",30, 20,10000,function::FunctionEnum::SCHWEFFEL, AlgorithmType::HILL_CLIMBING);

		sim.simulate("../output/converg_hill_dejong1_5dim",30, 5,10000,function::FunctionEnum::DEJONG_1, AlgorithmType::HILL_CLIMBING);
		sim.simulate("../output/converg_hill_dejong1_10dim",30, 10,10000,function::FunctionEnum::DEJONG_1, AlgorithmType::HILL_CLIMBING);
		sim.simulate("../output/converg_hill_dejong1_20dim",30, 20,10000,function::FunctionEnum::DEJONG_1, AlgorithmType::HILL_CLIMBING);
